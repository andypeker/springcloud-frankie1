...
//    @ApiResponse(code = 200, message = "success", response = User.class)
    ...
    public User userFallbackMethod(String id) {
        logger.warn("[fallbackMethod] userFallbackMethod is called !");
        return null;
    }
    ...
    public List<User> userList(HttpServletRequest request) {
        logger.warn("[fallbackMethod] userList is called !");
        return null;
    }
    ...
    public String ribbon() {
        ServiceInstance serviceInstance = loadBalancerClient.choose("springcloud-provider-multiple");
