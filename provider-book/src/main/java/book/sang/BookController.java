...
public class BookController {
    ...
    @RequestMapping(value = "/postbook2", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/putbook3/{id}", method = RequestMethod.PUT)
    public void book3(@RequestBody Book book, @PathVariable int id) {
        logger.info("book:" + book);
        logger.info("id:" + id);
    }

    @RequestMapping(value = "/delbook4/{id}", method = RequestMethod.DELETE)
